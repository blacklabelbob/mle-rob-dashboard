...
**Version:** 3.0.22 | **Created:** 2026-07-16 | **Updated:** 2026-07-21
**Status:** ACTIVE
**Owner:** Rob + Max
...
- [ ] Q9 *(2026-07-21, Rob dump 7.21.26-1 #1)*: **Global rename propagation "Please confirm"** — one dashboard rename (Proplogic→Proplogix) must propagate system-wide incl. Supabase. Max verifying with code-path evidence + honest caveats (fallback snapshot staleness) — BUILD-QUEUE Q13; reply goes to dev-chat when Rob finishes writing. (owner: Max)
