...
**Status:** IN PROGRESS — Phases 1–2 complete, Phase 3 at 1 of 4 (Tier A shipped; Tier B + allowlist + `npm run guard:pii` left) · **Owner:** Rob + Max · **Project:** MLE ROB Dashboard · **Type:** technical
...
graph LR
  ...
  P3["Phase 3 ▶ 1/4<br/>PII guard (CR-3)"]:::ready
