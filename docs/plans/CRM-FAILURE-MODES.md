...
| 5 | **Silent capture-workflow failure** (Gmail/AIDRE ingestion stops) | CRM quietly stops learning; looks fine, data is stale | **Task 3.6 — next up.** Planned: heartbeat/last-capture watchdog, alert within 15 min of a forced credential error | ⏳ OPEN |
